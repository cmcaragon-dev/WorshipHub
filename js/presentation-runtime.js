...
function rebuildLine(line) {
    // The source HTML stores the chord layout in a monospace <span class="chord">
    // followed by the lyric text. Build a REAL two-row block:
    //   ROW 1 = chords
    //   ROW 2 = lyrics
    // The chord row is the same font size as the lyric row. Horizontal chord
    // positions are calculated later from the saved character positions.
    const chordNodes = [...line.querySelectorAll(":scope > .chord")];
    // IMPORTANT: keep every space in the original chord span. Those spaces
    // are the character-grid positions entered by the admin/Add Song editor.
    // Removing whitespace here shifts every chord horizontally.
    ...
    chordRow.style.gridRow = "1";
    chordRow.style.position = "relative";
    chordRow.style.height = "1em";
    chordRow.style.minHeight = "1em";
    chordRow.style.maxHeight = "1em";
    ...
    lyricRow.style.gridRow = "2";
    lyricRow.style.height = "1em";
    lyricRow.style.minHeight = "1em";
    lyricRow.style.maxHeight = "1em";
    ...
    line.style.gridTemplateRows = "1em 1em";
    line.style.height = "2em";
    line.style.minHeight = "2em";

...
(function(){
  ...
  function buildDashboard(){
    ...
    box.innerHTML=`<div class="chordio-quick">
      ...
      <div class="chordio-quick-grid">
        <button type="button" data-quick="service" class="primary"><i class="fa-solid fa-calendar-plus" aria-hidden="true"></i><span>New Service</span></button>
        <button type="button" data-quick="planner"><i class="fa-solid fa-calendar-days" aria-hidden="true"></i><span>Service Planner</span></button>
        <button type="button" data-quick="multi"><i class="fa-solid fa-display" aria-hidden="true"></i><span>Multi-Screen</span></button>
        <button type="button" data-quick="songs"><i class="fa-solid fa-music" aria-hidden="true"></i><span>Songs</span></button>
        <button type="button" data-quick="addsong"><i class="fa-solid fa-file-circle-plus" aria-hidden="true"></i><span>Add Song</span></button>
      </div>
    </div>`;
  ...
  function buildSidebarQuickActions(){
    ...
    side.innerHTML=`<div class="chordio-sidebar-welcome"><div class="chordio-sidebar-welcome-label">Hello, Welcome</div><div id="chordioSidebarUserName" class="chordio-sidebar-welcome-name">User</div></div><div class="chordio-sidebar-actions">
      <div class="chordio-sidebar-kicker">QUICK ACTIONS</div>
      <button type="button" class="chordio-sidebar-action primary" data-sidebar-quick="service"><i class="fa-solid fa-calendar-plus" aria-hidden="true"></i><span>New Service</span></button>
      <button type="button" class="chordio-sidebar-action" data-sidebar-quick="planner"><i class="fa-solid fa-calendar-days" aria-hidden="true"></i><span>Service Planner</span></button>
      <button type="button" class="chordio-sidebar-action" data-sidebar-quick="multi"><i class="fa-solid fa-display" aria-hidden="true"></i><span>Multi-Screen</span></button>
      <button type="button" class="chordio-sidebar-action" data-sidebar-quick="songs"><i class="fa-solid fa-music" aria-hidden="true"></i><span>Songs</span></button>
      <button type="button" class="chordio-sidebar-action" data-sidebar-quick="addsong"><i class="fa-solid fa-file-circle-plus" aria-hidden="true"></i><span>Add Song</span></button>
    ...
    const syncSidebarUser=()=>{const src=document.getElementById('userName'),dst=document.getElementById('chordioSidebarUserName');if(src&&dst)dst.textContent=src.textContent||'User'};syncSidebarUser();setTimeout(syncSidebarUser,500);setTimeout(syncSidebarUser,1500);

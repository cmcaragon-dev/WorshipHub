...
function openSettings() {
    // Settings is a dedicated page, not an overlay on the dashboard.
    if (document.getElementById("adminSettingsContent")) {
        renderSettings();
        return;
    }
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Dedicated settings page: render directly into the page content.
    if (document.getElementById("adminSettingsContent")) {
        renderSettings();
    }
});
